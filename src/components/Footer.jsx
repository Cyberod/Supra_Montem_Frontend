export default function Footer() {
  return (
      <div className="max-w-[1440px] h-[685.14px] px-[120px] pb-[28px] pt-[64px] bg-midnight">
        ...
        <div className="flex max-w-[1120px] overflow-hidden inline-flex gap-10  absolute pt-[87px] pb-[88.57] mb-[28px]">
            <img src="/SUPRAMONTEM.png" alt="SUPRAMONTEM" className="animate-marquee max-w-[1833px] h-[94px]"/>
