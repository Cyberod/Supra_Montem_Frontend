export default function Footer() {
  return (
      <div className="max-w-[1440px] max-h-[685.14px] px-[120px] pb-[28px] pt-[64px] bg-midnight">
        ...
        <div className="max-w-[1200px] px-[40px] text-white mt-[40px]">
            ...
            <div className="pt-[87px] pb-[88.57] mb-[28px]">
                <img src="/SUPRAMONTEM.png" alt="SUPRAMONTEM" />
            </div>
        </div>
